...
function getStockOpt(id,name){
	...
	console.log($(".detailAddr").attr('name'));
	$(".detailAddr").val(address);
}
...
function chooseCity(cityId,cityName){
	...
	$.getJSONP("//d.jd.com/area/get?fid="+cityId+"&callback=getAreaListcallback");
}
function chooseArea(areaId,areaName){
	...
	$.getJSONP("//d.jd.com/area/get?fid="+areaId+"&callback=getAreaListcallback");
}
