...
public class DateUtil {
	...
	public static SimpleDateFormat sdf6 = new SimpleDateFormat("MM月dd日");
	public static SimpleDateFormat sdf7 = new SimpleDateFormat("yyyyMMddHHmmss");
	public static SimpleDateFormat sdf8 = new SimpleDateFormat("YYYY/MM/DD HH:mm:ss");
	public static SimpleDateFormat sdf9 = new SimpleDateFormat("yyyy-MM");
	public static SimpleDateFormat sdf10 = new SimpleDateFormat("yyyy年MM月dd日");
	/**
	 ...
	 *             异常：非法日期格式
	 */
	public static String FormatTime() throws RuntimeException {
		Date d = new Date();
		return sdf.format(d);
	}

	/**
	 * 获取传入时间 的yyyy-MM-dd HH:mm:ss格式
	 * 
	 * @param parttern
	 *            日期格式
	 * @return SimpleDateFormat对象
	 ...
	 *             异常：非法日期格式
	 */
	public static String FormatTime(Date d) throws RuntimeException {
		if (d != null)
			return sdf.format(d);
		return null;
	}
