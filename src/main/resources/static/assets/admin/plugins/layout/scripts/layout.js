...
var Layout = function () {
    ...
    // Handles selected sidebar
    var handleSelectedSidebar = function () {
        var selectSidebar = function(menuid){
        	var hasSubMenu = $('#'+menuid).parent().hasClass('sub-menu');
        	if(hasSubMenu){
        		$('#'+menuid).addClass("active");
        		var parentMenu = $('#'+menuid).parent().parent();
        		parentMenu.addClass("open");
        		parentMenu.find(".arrow").addClass("open");
        		selectSidebar(parentMenu.attr("id"));	        	
        	}else{
        		$('#'+menuid).addClass("active");
	        	$('#'+menuid).find("a").append("<span class='selected'></span>");
        	}
        };
        if ($.cookie){
        	var act_menu = $.cookie('sidebar_selected');
        	if(act_menu != undefined){
        		selectSidebar(act_menu);
        	}else{
        		//默认选中第一个菜单
        		//var oneMenu = $('.page-sidebar-menu li').eq(2).attr("id");
        		//selectSidebar(oneMenu);
        	}
        	
        	$('.page-sidebar').on('click', 'li > a', function () {
        		$.cookie('sidebar_selected',$(this).parent().attr("id"));
        	});
        }
     };
    ...
    return {
        ...
        initSidebar: function() {
            ...
            handleSelectedSidebar(); // handles selected sidebar
